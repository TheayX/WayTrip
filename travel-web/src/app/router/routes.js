...
const publicRoutes = [
  ...
  { path: 'spots/:id', name: ROUTE_NAMES.spotDetail, component: () => import('@/modules/spot/pages/detail.vue'), meta: { title: '景点详情', requiresAuth: true } },
  ...
  { path: 'order/create/:spotId', name: ROUTE_NAMES.orderCreate, component: () => import('@/modules/order/pages/create.vue'), meta: { title: '创建订单', requiresAuth: true, showAiChat: false } },
...
const accountRoutes = [
  ...
  { path: 'orders', name: ROUTE_NAMES.orderList, component: () => import('@/modules/order/pages/list.vue'), meta: { title: '我的订单', requiresAuth: true, showAiChat: true } },
  { path: 'orders/:id', name: ROUTE_NAMES.orderDetail, component: () => import('@/modules/order/pages/detail.vue'), meta: { title: '订单详情', requiresAuth: true, showAiChat: true } },
