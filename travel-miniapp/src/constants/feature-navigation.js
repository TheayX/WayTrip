...
const featureEntries = [
  ...
  { id: 'blindbox', title: '随心一选', desc: '随机抽一个目的地', icon: 'gift-filled', theme: 'purple', url: '/pages/feature/blindbox/index', section: 'feature' },
  { id: 'budget', title: '穷游玩法', desc: '低预算景点和攻略', icon: 'wallet-filled', theme: 'orange', url: '/pages/feature/budget/index', section: 'feature' },
  { id: 'reviews', title: '游客口碑', desc: '看游客真实评价', icon: 'chatboxes-filled', theme: 'blue', url: '/pages/feature/reviews/index', section: 'feature' },
  { id: 'recent-views', title: '近期热看', desc: '看看最近浏览更高的景点', icon: 'eye-filled', theme: 'amber', url: '/pages/feature/recent-views/index', section: 'feature' },
