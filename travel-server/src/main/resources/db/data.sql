-- ============================================================
-- WayTrip initial data
-- Idempotent by truncating tables before insert
-- ============================================================
USE waytrip_db;
...
VALUES
  ('故宫博物院', '明清两代皇宫建筑群，适合历史文化深度游。', 60.00, '08:30-17:00', '北京市东城区景山前街4号',
   39.9163450, 116.3971550, '/uploads/images/default.jpg', 10, 9, 9800, 5.0, 2, 1),
  ('颐和园', '皇家园林代表景区，昆明湖与万寿山景观完整。', 30.00, '06:30-18:00', '北京市海淀区新建宫门路19号',
   39.9993670, 116.2756250, '/uploads/images/default.jpg', 10, 9, 8600, 4.5, 2, 1),
  ('西湖', '杭州城市名片，免费开放，适合慢节奏漫游。', 0.00, '全天开放', '浙江省杭州市西湖区龙井路1号',
   30.2428650, 120.1486810, '/uploads/images/default.jpg', 7, 13, 9600, 4.3, 3, 1),
  ('上海迪士尼乐园', '大型主题乐园，适合亲子和情侣出游。', 475.00, '08:30-20:30', '上海市浦东新区川沙新镇黄赵路310号',
   31.1439040, 121.6694720, '/uploads/images/default.jpg', 13, 10, 9400, 4.5, 2, 1),
  ('兵马俑', '秦始皇兵马俑博物馆，西安代表性历史景点。', 120.00, '08:30-18:00', '陕西省西安市临潼区秦陵北路',
   34.3844310, 109.2783570, '/uploads/images/default.jpg', 11, 15, 8800, 5.0, 2, 1),
  ('成都大熊猫繁育研究基地', '成都热门景区，适合家庭游客和首次到访游客。', 55.00, '07:30-18:00', '四川省成都市成华区外北熊猫大道1375号',
   30.7340000, 104.1458000, '/uploads/images/default.jpg', 7, 14, 8200, 4.5, 2, 1),
  ('外滩', '上海经典滨江景观带，夜景辨识度高。', 0.00, '全天开放', '上海市黄浦区中山东一路',
   31.2400400, 121.4907900, '/uploads/images/default.jpg', 15, 10, 7900, 4.0, 2, 1),
  ('洪崖洞', '重庆热门夜景打卡地，适合夜游和美食体验。', 0.00, '全天开放', '重庆市渝中区嘉陵江滨江路88号',
   29.5630000, 106.5780000, '/uploads/images/default.jpg', 16, 16, 7600, 3.5, 2, 1),
  ('广州塔', '广州地标建筑，可观景、拍照、体验高空项目。', 150.00, '09:30-22:30', '广东省广州市海珠区阅江西路222号',
   23.1085240, 113.3191440, '/uploads/images/default.jpg', 15, 11, 7300, 5.0, 1, 1),
  ('深圳欢乐谷', '深圳热门大型乐园，项目丰富，周末客流较高。', 230.00, '10:00-22:00', '广东省深圳市南山区侨城西街18号',
   22.5391730, 113.9732300, '/uploads/images/default.jpg', 13, 12, 7100, 4.0, 1, 1),
  ('南京夫子庙', '南京传统文化街区，兼具夜游、美食与人文体验。', 0.00, '全天开放', '江苏省南京市秦淮区贡院西街53号',
   32.0228190, 118.7923640, '/uploads/images/default.jpg', 16, 17, 7000, 4.0, 1, 1),
  ('拙政园', '苏州古典园林代表，适合园林审美与慢游。', 80.00, '07:30-17:30', '江苏省苏州市姑苏区东北街178号',
   31.3269070, 120.6313240, '/uploads/images/default.jpg', 10, 18, 7450, 5.0, 1, 1);
